...
#define MAPSEC_PLAYGROUND 0x00
#define MAPSEC_PETRIFACTHEIM_CITY 0x01
#define MAPSEC_DEWFORD_TOWN 0x02
#define MAPSEC_LAVARIDGE_TOWN 0x03  // UNUSED
#define MAPSEC_FALLARBOR_TOWN 0x04  // UNUSED
#define MAPSEC_VERDANTURF_TOWN 0x05 // UNUSED
#define MAPSEC_PACIFIDLOG_TOWN 0x06 // UNUSED
#define MAPSEC_UNUSED 0x07          // UNUSED
#define MAPSEC_OLDALE_TOWN 0x08     // UNUSED
