...
// Towns and Cities
#define FLAG_VISITED_PLAYGROUND (SYSTEM_FLAGS + 0xF)
#define FLAG_VISITED_PETRIFACTHEIM_CITY (SYSTEM_FLAGS + 0x10)
#define FLAG_VISITED_DEWFORD_TOWN (SYSTEM_FLAGS + 0x11)     // UNUSED
#define FLAG_VISITED_LAVARIDGE_TOWN (SYSTEM_FLAGS + 0x12)   // UNUSED
#define FLAG_VISITED_FALLARBOR_TOWN (SYSTEM_FLAGS + 0x13)   // UNUSED
#define FLAG_VISITED_VERDANTURF_TOWN (SYSTEM_FLAGS + 0x14)  // UNUSED
#define FLAG_VISITED_PACIFIDLOG_TOWN (SYSTEM_FLAGS + 0x15)  // UNUSED
#define FLAG_VISITED_PETALBURG_CITY (SYSTEM_FLAGS + 0x16)   // UNUSED
#define FLAG_VISITED_OLDALE_TOWN (SYSTEM_FLAGS + 0x17)      // UNUSED
#define FLAG_VISITED_MAUVILLE_CITY (SYSTEM_FLAGS + 0x18)    // UNUSED
#define FLAG_VISITED_RUSTBORO_CITY (SYSTEM_FLAGS + 0x19)    // UNUSED
#define FLAG_VISITED_FORTREE_CITY (SYSTEM_FLAGS + 0x1A)     // UNUSED
#define FLAG_VISITED_LILYCOVE_CITY (SYSTEM_FLAGS + 0x1B)    // UNUSED
#define FLAG_VISITED_MOSSDEEP_CITY (SYSTEM_FLAGS + 0x1C)    // UNUSED
#define FLAG_VISITED_SOOTOPOLIS_CITY (SYSTEM_FLAGS + 0x1D)  // UNUSED
#define FLAG_VISITED_EVER_GRANDE_CITY (SYSTEM_FLAGS + 0x1E) // UNUSED
...
#define FLAG_VISITED_ROUTE134 (SYSTEM_FLAGS + 0xA6) // UNUSED
#define FLAG_VISITED_MT_CHIMNEY (SYSTEM_FLAGS + 0xA7)
#define FLAG_VISITED_ROUTE01 (SYSTEM_FLAGS + 0xA8) // Unused Flag
