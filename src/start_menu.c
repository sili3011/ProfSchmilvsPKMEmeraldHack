...
static bool32 InitStartMenuStep(void)
{
    ...
    case 2:
        ...
        DrawStdWindowFrame(GetWindowId(sNumStartMenuActions), FALSE);
...
static bool8 HandleStartMenuInput(void)
{
    ...
    if (JOY_NEW(A_BUTTON))
    {
        ...
        if (gMenuCallback != StartMenuSaveCallback && gMenuCallback != StartMenuExitCallback && gMenuCallback != StartMenuSafariZoneRetireCallback && gMenuCallback != StartMenuBattlePyramidRetireCallback)
        {
