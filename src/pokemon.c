...
// in-battle stat boosting effects
        ...
        // in-battle stat boosting effects
        case 1:
            if ((itemEffect[cmdIndex] & ITEM1_X_ATTACK) && gBattleMons[gActiveBattler].statStages[STAT_ATK] < MAX_STAT_STAGE)
            {
                if (B_X_ITEMS_BUFF == GEN_7)
                    gBattleMons[gActiveBattler].statStages[STAT_ATK] += 2;
                else
            ...
            if ((itemEffect[cmdIndex] & ITEM1_X_DEFENSE) && gBattleMons[gActiveBattler].statStages[STAT_DEF] < MAX_STAT_STAGE)
            {
                if (B_X_ITEMS_BUFF == GEN_7)
                    gBattleMons[gActiveBattler].statStages[STAT_DEF] += 2;
                else
            ...
            if ((itemEffect[cmdIndex] & ITEM1_X_SPATK) && gBattleMons[gActiveBattler].statStages[STAT_SPATK] < MAX_STAT_STAGE)
            {
                if (B_X_ITEMS_BUFF == GEN_7)
                    gBattleMons[gActiveBattler].statStages[STAT_SPATK] += 2;
                else
            ...
            if ((itemEffect[cmdIndex] & ITEM1_X_SPDEF) && gBattleMons[gActiveBattler].statStages[STAT_SPDEF] < MAX_STAT_STAGE)
            {
                if (B_X_ITEMS_BUFF == GEN_7)
            ...
            if ((itemEffect[cmdIndex] & ITEM1_X_ACCURACY) && gBattleMons[gActiveBattler].statStages[STAT_ACC] < MAX_STAT_STAGE)
            {
                if (B_X_ITEMS_BUFF == GEN_7)
                    gBattleMons[gActiveBattler].statStages[STAT_ACC] += 2;
                else
...
{
    if (species == SPECIES_SPINDA && dest != gMonSpritesGfxPtr->sprites.ptr[0] && dest != gMonSpritesGfxPtr->sprites.ptr[2])
    {
        int i;
        for (i = 0; i < 4; i++)
        {
