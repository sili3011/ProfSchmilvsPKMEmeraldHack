...
static void QueueAnimTiles_Rustboro_WaterCurrents(u8);
...
static void TilesetAnim_Rustboro(u16 timer)
{
    ...
    if (timer % 16 == 1)
        QueueAnimTiles_Rustboro_WaterCurrents(timer >> 4);
}
...
static void QueueAnimTiles_Rustboro_WaterCurrents(u8 timer)
{
    u8 i = timer % 8;
    AppendTilesetAnimToBuffer(gTilesetAnims_Pacifidlog_WaterCurrents[i], (u16 *)(BG_VRAM + TILE_OFFSET_4BPP(NUM_TILES_IN_PRIMARY + 400)), 0x100);
}
